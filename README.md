...
|-----------|-------------|------------|
| **Welcome Cover** | Hero welcome screen with call-to-action and brief value props. | ![Welcome Screen](docs/screenshots/safe-comply-welcome.webp) |
| **Dashboard Overview** | KPI tiles, trends, and alert summaries for quick status. | ![Dashboard](docs/screenshots/safe-comply-dashboard.webp) |
| **Password Policies** | Rule editor, strength scoring, and guidance hints. | ![Password Policies](docs/screenshots/safe-comply-password-policies.webp) |
| **Backup Policies** | Schedule visibility, last-run status, and coverage indicators. | ![Backup Policies](docs/screenshots/safe-comply-backup-policies.webp) |
| **Reports & Exports** | Report list with filters plus PDF/Excel export actions. | ![Reports](docs/screenshots/safe-comply-reports.webp) |
